...
/**
 * We do NOT have the EnableWebMvc annotation here so we get all that Spring
 * Boot autoconfiguration mojo!
 *
 * Lots of search results include EnableWebMvc but don't mention that it
...
public class WebAppConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry resourceHandlerRegistry) {
		...
		resourceHandlerRegistry.addResourceHandler(SWAGGER_RESOURCES)
